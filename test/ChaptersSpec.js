...
describe('Chapters', () => {
  ...
  describe('GET /v1/jwt/chapters/:chapterId', async () => {
    ...
    it('should reject chapter ids that are not numbers', async () => {
      ...
      const response = await request(serverInstance)
        .get('/v1/jwt/chapters/;drop table chapter;')
        .send();
  ...
  describe('GET /v1/jwt/chapters/:chapterId/details', async () => {
    it('should return details about a chapter', async () => {

      const response = await request(serverInstance)
        .get('/v1/jwt/chapters/1/details')
        .send();
    ...
    it('should reject chapter ids that are out of range', async () => {
      ...
      const response = await request(serverInstance)
        .get('/v1/jwt/chapters/5000/details')
        .send();
    ...
    it('should reject chapter ids that are not numbers', async () => {
      ...
      const response = await request(serverInstance)
        .get('/v1/jwt/chapters/;drop table chapter;/details')
        .send();
